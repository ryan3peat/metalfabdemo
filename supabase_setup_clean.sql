...
-- Step 1: Create all ENUM types (only if they don't exist)
DO $$ 
BEGIN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'form') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'magic_link_type') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'preliminary_approval_status') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'finish') THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'quote_requests_created_by_users_id_fk'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'request_suppliers_request_id_quote_requests_id_fk'
    ) THEN
        ALTER TABLE request_suppliers 
            ADD CONSTRAINT request_suppliers_request_id_quote_requests_id_fk 
            FOREIGN KEY (request_id) REFERENCES quote_requests(id) ON DELETE CASCADE ON UPDATE NO ACTION;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'request_suppliers_supplier_id_suppliers_id_fk'
    ) THEN
        ALTER TABLE request_suppliers 
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'supplier_quotes_request_id_quote_requests_id_fk'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'supplier_quotes_supplier_id_suppliers_id_fk'
    ) THEN
        ALTER TABLE supplier_quotes 
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'supplier_quotes_preliminary_approved_by_users_id_fk'
    ) THEN
        ALTER TABLE supplier_quotes 
            ADD CONSTRAINT supplier_quotes_preliminary_approved_by_users_id_fk 
            FOREIGN KEY (preliminary_approved_by) REFERENCES users(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'supplier_documents_supplier_quote_id_supplier_quotes_id_fk'
    ) THEN
        ALTER TABLE supplier_documents 
            ADD CONSTRAINT supplier_documents_supplier_quote_id_supplier_quotes_id_fk 
            FOREIGN KEY (supplier_quote_id) REFERENCES supplier_quotes(id) ON DELETE CASCADE ON UPDATE NO ACTION;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'supplier_documents_uploaded_by_users_id_fk'
    ) THEN
        ALTER TABLE supplier_documents 
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'document_requests_quote_id_supplier_quotes_id_fk'
    ) THEN
        ALTER TABLE document_requests 
            ADD CONSTRAINT document_requests_quote_id_supplier_quotes_id_fk 
            FOREIGN KEY (quote_id) REFERENCES supplier_quotes(id) ON DELETE CASCADE ON UPDATE NO ACTION;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'document_requests_requested_by_users_id_fk'
    ) THEN
        ALTER TABLE document_requests 
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'notifications_related_quote_id_supplier_quotes_id_fk'
    ) THEN
        ALTER TABLE notifications 
            ADD CONSTRAINT notifications_related_quote_id_supplier_quotes_id_fk 
            FOREIGN KEY (related_quote_id) REFERENCES supplier_quotes(id) ON DELETE CASCADE ON UPDATE NO ACTION;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'notifications_related_request_id_quote_requests_id_fk'
    ) THEN
        ALTER TABLE notifications 
            ADD CONSTRAINT notifications_related_request_id_quote_requests_id_fk 
            FOREIGN KEY (related_request_id) REFERENCES quote_requests(id) ON DELETE CASCADE ON UPDATE NO ACTION;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'suppliers_created_by_users_id_fk'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'supplier_applications_reviewed_by_users_id_fk'
    ) THEN
